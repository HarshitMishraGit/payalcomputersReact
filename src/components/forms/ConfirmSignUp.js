  ...
  return (
      <div className='my-3'>
          ...
          <label htmlFor="otp" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enter The OTP</label>
                      ...
                      <ErrorMessage className="text-orange-700 dark:text-orange-400 text-xs" name="otp" component="span"/>
                      {wrongOtp && <p  className="text-orange-700 dark:text-orange-400 text-xs">Wrong Otp</p>}
          </div>
