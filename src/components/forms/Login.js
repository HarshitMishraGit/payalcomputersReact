...
//==================>>>>>>>>>>>>>> to display immidiate action on the login page
    ...
    <div className='w-full md:w-1/3 mx-auto my-10 bg-gray-200 dark:bg-gray-800 px-7 py-3 rounded-lg'>
...
<label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Email</label>
            ...
            <ErrorMessage className="text-orange-800 dark:text-orange-400 text-xs" name="email" component="span"/>
...
<label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your password</label>
            ...
            <ErrorMessage className="text-orange-800 dark:text-orange-400 text-xs" name="password" component="span"/>
